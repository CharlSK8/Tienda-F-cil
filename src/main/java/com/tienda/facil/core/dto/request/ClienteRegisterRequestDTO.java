...
public class ClienteRegisterRequestDTO {
    ...
    @Schema(description = "Primer apellido del usuario", example = "López", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Número de contacto del usuario", example = "3015501212", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlank(message = "El campo 'contacto' es obligatorio")
